(function() {
    ...
    $(document).ready(function(){
        ...
        $('.choose_city_pull').click(function(){
            $(this).parent('.choose_city_block_new').toggleClass('active'); 
            $('.choose_city_pull').toggleClass('active'); 
            $(this).parents('.choose_city_block_new').find('.choose_city_block_new_hidden').fadeToggle('400');
        });
    ...
    $(document).click( function(){
        if( $(event.target).closest(".choose_city_block_new").length ) 
            return;
        $(".choose_city_block_new_hidden").fadeOut(400);
        $(".choose_city_block_new").removeClass('active');
        $(".choose_city_pull").removeClass('active');
    });
